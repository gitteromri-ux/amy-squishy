...
const CATEGORIES = [
  ...
  { id: "food",     name: "אוכל, חטיפים ופירות",   emoji: "🍔", desc: "המבורגרים, דאמפלינג, פירות, ארטיקים וכל הפינוקים המתוקים" },
...
const PRODUCTS = [
  ...
  // ---------- פירות וירקות ----------
  P("אבטיח מצחיק נידו", "food", 18.9, { emoji: "🍉",  source: "Pinky Fidgets" }),
  P("נידו מיני אננס", "food", 16.9, { emoji: "🍍",  source: "Gilgi" }),
  P("נידו עגבניית שרי", "food", 14.9, { emoji: "🍅",  source: "Gilgi" }),
  P("נידו מנגו פרימיום", "food", 29.9, { emoji: "🥭",  badge: "פרימיום", source: "Gilgi" }),
  P("נידו גזר יפני צהוב ענקי", "food", 45.0, { emoji: "🥕",  badge: "ענק", source: "Gilgi" }),
  P("מנגו לחיץ", "food", 15.0, { emoji: "🥭",  source: "Sindya" }),
  P("אבטיח גדול אורביז", "orbiz", 15.0, { emoji: "🍉",  source: "Sindya" }),
  P("נידו גזר ענק מחליף צבע", "food", 45.0, { emoji: "🥕",  badge: "ענק", source: "Sindya" }),
  P("אבטיח ענק נידו", "food", 45.0, { emoji: "🍉",  badge: "ענק", source: "Sindya" }),
  P("זוג לימונים פרצופים", "food", 15.0, { emoji: "🍋",  source: "Sindya" }),
  ...
  // ---------- ארטיק וקינוחים ----------
  P("ארטיק צבעוני דביק", "food", 20.0, { emoji: "🍦",  source: "Sindya" }),
  P("חפיסת שוקולד", "food", 25.0, { emoji: "🍫",  source: "Sindya" }),
  P("שוקולד רובי ורוד", "food", 26.9, { emoji: "🍫",  source: "Gilgi" }),
